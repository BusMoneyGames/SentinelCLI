...
# components['group into bin']['config']['sync_eos_count'] = \
#     components['is asset type known']['instance_count']
# components['group into bins by type']['config']['sync_eos_count'] = \
#     components['is asset type known']['instance_count']
...
if __name__ == '__main__':
    ...
    builder.broadcast('pre.directory', {'end_of_stream': True})
